...
public abstract class AbstractWorkflowEngine implements WorkflowEngine {
    ...
    public void init() {
        ...
        for (WorkflowInstance workflowInstance : workflowInstances) {
            ...
            Map<Long, TaskInstanceWithDependency> dependenciesMapping = buildWorkflowAndDependencies(workflowInstance.getWorkflowId(), workflowInstanceId,
                    this.taskInstanceService.listByWorkflowInstanceId(workflowInstanceId));
            submitToWorker(this.workflowService.get(workflowInstance.getWorkflowId()), workflowInstanceId, dependenciesMapping);
        }
    ...
    protected Map<Long, TaskInstanceWithDependency> buildWorkflowAndDependencies(Long workflowId, Long workflowInstanceId, List<TaskInstance> taskInstances) {
        ...
        for (TaskInstance taskInstance : taskInstances) {
            List<Long> dependencyTaskIds = this.workflowDetailService.listDependencyTaskIds(workflowId, taskInstance.getTaskId());
            ...
            TaskInstanceWithDependency taskInstanceWd = new TaskInstanceWithDependency(task, teamId, taskInstance, dependencyTaskInstanceIds);
    ...
    protected void submitToWorker(Workflow workflow, Long workflowInstanceId, Map<Long, TaskInstanceWithDependency> dependenciesMapping) {
    ...
    protected boolean hasFailTask(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
        for (TaskInstanceWithDependency taskInstanceWd : taskInstanceWithDependencies) {
            TaskInstance taskInstance = taskInstanceWd.getTaskInstance();
    ...
    protected boolean isAllTasksCompleted(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
        for (TaskInstanceWithDependency taskInstanceWd : taskInstanceWithDependencies) {
            TaskInstance taskInstance = taskInstanceWd.getTaskInstance();
    ...
    protected boolean isAllTasksSuccess(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
        for (TaskInstanceWithDependency taskInstanceWd : taskInstanceWithDependencies) {
            TaskInstance taskInstance = taskInstanceWd.getTaskInstance();
    ...
    protected void workflowFail(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
    ...
    protected boolean hasCancelledTaskAndNoUncompleted(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
    ...
    protected boolean handleCancelIfNeeded(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
        if (this.cancelledWorkflowInstanceIdSet.contains(workflowInstanceId)) {
            for (TaskInstanceWithDependency taskInstanceWd : taskInstanceWithDependencies) {
                TaskInstance taskInstance = taskInstanceWd.getTaskInstance();
    ...
    protected void cancelAllRunningTasks(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
        for (TaskInstanceWithDependency taskInstanceWd : taskInstanceWithDependencies) {
            TaskInstance taskInstance = taskInstanceWd.getTaskInstance();
    ...
    protected void setAllDependencyWaitTasksAsWorkflowFail(Long workflowInstanceId, Collection<TaskInstanceWithDependency> taskInstanceWithDependencies) {
        for (TaskInstanceWithDependency taskInstanceWd : taskInstanceWithDependencies) {
            TaskInstance taskInstance = taskInstanceWd.getTaskInstance();
            TaskInstanceStatus status = taskInstance.getStatus();
    ...
    protected void submitToTaskInstanceExecutorIfConditionSatisfy(Workflow workflow, WorkflowInstance workflowInstance,
        ...
        ConditionContext context = new ConditionContext(workflow, workflowInstance, this.workflowDetailService.get(workflowInstance.getWorkflowId(), taskId),
                this.taskService.get(taskId), taskInstance, dependencyTaskInstances);
